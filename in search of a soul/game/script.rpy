...
label start:
    ...
    label next_day:
        ...
        e "-_-"
        e "Ну раз похуй куда идти, то я сам выберу..."

        menu:
            "Пойти в город":
                e "Я решил, что хочу пойти в город."
                goloc "Ты уверен, что хочешь в город? Ты же беглый раб."
                e "И что теперь? Мне больше нельзя в церковь ходить?"
                goloc "Ну церковь это святое."
                
            "Остаться в лесу":
                e "Я решил остаться в лему на некоторе время."
                goloc "Ну да, залечь на дно тебе не помешает."
                "'И блуждая, Эльмир понимает лишь одно. Он проголодался.'"
                e "Голос, я впервые нахожусь в лесу, Я очень хочу есть. Где раздобыть еды в лесу?"
                goloc ""
